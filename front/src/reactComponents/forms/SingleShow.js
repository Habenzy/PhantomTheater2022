  ...
  return (
    <div className="single_show">
      ...
      <span>
        ...
        <a
          className="dashLink"
          href={`https://www.phantomtheater.org/artistForm#${props.id}`}
        >
          {`https://www.phantomtheater.org/artistForm#${props.id}`}
        </a>
      </span>

      <div className="singleShowLine">
        <p>Artist: </p> {props.artist}
      </div>
      <div className="singleShowLine">
        <p>Show type: </p>
        {props.type}
      </div>
      <div className="singleShowLineSum">
        <p>Summary: </p>
        {props.blurb}
      </div>
      <div className="singleShowLine">
