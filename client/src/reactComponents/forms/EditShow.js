...
export default function EditShow() {
  ...
  async function enterUpdates(event) {
    ...
    console.log("Updating...", showUpdate.dates);
            ...
            >
              <div id="artistInfoCard" className="d-flex flex-direction row-3">
                ...
                <Card.Body className="admin">
                  ...
                  {/* FUTURE REFACTOR: build a display window that shows dates - make 'add a shwtime' button the single dates input for dates in the db */}
                  <Form.Group>
